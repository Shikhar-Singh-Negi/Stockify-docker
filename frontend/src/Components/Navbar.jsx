  ...
  return (
    <div className="bg-gray-800">
      <nav className="flex justify-between items-center py-4 px-10">
        ...
        <div>
          <button className="text-white px-6 py-2 bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none transition duration-300 mr-4">           <Link to='/LoginPage'>Login</Link></button>
