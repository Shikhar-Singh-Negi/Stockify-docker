  ...
  return (
    <footer className="bg-blue-950 text-white py-8">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <h2 className="text-2xl font-semibold">Stockify</h2>
          <p className="text-gray-300 mt-2">Efficient Inventory Management, Simplified.</p>
          <p className="text-sm text-gray-400 mt-4">© {new Date().getFullYear()} Stockify. All rights reserved.</p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-300">Email: support@stockify.com</p>
          <p className="text-gray-300">Meston Road, Kanpur</p>
